...
*/
    public static int sumArray(Roll roll) {
        int sum = 0;
        for (int i = 0; i < roll.getRoll().length; i++) {
            sum += roll.getRoll()[i];
        }
        return sum;
    }
    ...
    public static int sumOfEyes(int eye, Roll roll){
        int sum = 0;
        for (int i = 0; i < roll.getRoll().length; i++) {
            if (roll.getRoll()[i] == eye) {
                sum += roll.getRoll()[i];
            }
        }
        return sum;
